...
export const modalTheme: CustomFlowbiteTheme["modal"] = {
  root: {
    ...
    show: {
      on: "flex bg-gray-900 bg-opacity-50 dark:bg-opacity-60 pt-14",
      off: "hidden",
    },
    sizes: {
      sm: "max-w-sm",
  ...
  content: {
    ...
    inner:
      "relative flex max-h-[94dvh] w-full flex-col rounded-lg bg-white shadow shadow-black dark:bg-gray-700",
  },
  body: {
